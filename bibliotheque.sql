...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 22 déc. 2023 à 16:28
...
('Admin1', 'azerty', 'Le Fèvre', 'Erwan', '4 Le Bourg', 'Pléguien', 22290, 'admin'),
('Utilisateur1', 'azerty', 'Roux', 'Bastien', '11 rue du Courtil Rose', 'Ploufragant', 22480, 'utilisateur');
...
--
ALTER TABLE `livre`
  MODIFY `nolivre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
