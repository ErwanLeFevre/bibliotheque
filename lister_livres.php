...
<body>
    ...
    <?php
            if(isset($auteur)){
                if($auteur === "*"){
                    $req = $connexion->prepare("SELECT nolivre,image,anneeparution,resume,titre FROM livre INNER JOIN auteur ON livre.noauteur = auteur.noauteur");
                } else {
                    $req = $connexion->prepare("SELECT nolivre,image,anneeparution,resume,titre FROM livre INNER JOIN auteur ON livre.noauteur = auteur.noauteur WHERE nom LIKE :auteur;");
                        ...
                        ?>
                            <div class="resultat-container" id="livre_'.$livre->nolivre.'">
                                ...
                                <div class="resultat-info">
                                    ...
                                    <p class="resultat-resume">'.$livre->resume.'</p>
